...
**Status:** Rechartered 2026-09-13, pending owner stamp. Supersedes `docs/charter-movement-x.md`, which stays on disk as the rejected-direction record (same disposition as the Listening View charter). **Amended 2026-09-14:** the letter ruler built early as Phase 1.5; the discography and album place redesigned away before being built — one river species serves everything (§2, §4, §5). **Amended 2026-09-15:** the artist-river entrance rebuilt as **the parting** — staged fade beats, no zoom, the blurred-art veil retired (§4). **Amended 2026-09-16:** the artist river is a hybrid by size — rivers that fill the band ring (newest centered, oldest wrapping above; an owner-ruled reversal of the ring retirement), smaller rivers are bounded in 2 / 1 / 3 order (second-newest above, newest centered, oldest last); the summon landing law partially delivered — artist, album and song results land through the shelf ceremony (§7).
